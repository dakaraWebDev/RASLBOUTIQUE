...
const Header = () => {
   ...
   return (
      <div className='fixed w-full h-min z-30'>
         <header className='flex justify-between items-center px-6 w-full max-w-[1440px] bg-white h-20'>
            ...
            <a href="https://www.tokopedia.com/rasl"><Image id='srcBtn' className='cursor-pointer' width='40px' height='40px' src={search} alt='logo'/></a>
         </header>
